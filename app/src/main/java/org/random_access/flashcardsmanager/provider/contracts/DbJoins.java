...
public class DbJoins {
    ...
    public static final String TABLES_FLASHCARDS_JOIN_LFRELS = FlashCardContract.TABLE_NAME + " inner join " + LFRelationContract.TABLE_NAME
    ...
    public static final String TABLES_LABELS_JOIN_LFRELS = LabelContract.TABLE_NAME + " inner join " + LFRelationContract.TABLE_NAME
